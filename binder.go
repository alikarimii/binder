...
const (
	...
	MIMEUnsupport       = "unsupport media type"
	//
...
type (
	...
	Binder interface {
		...
		BindPathParams(req *http.Request, i interface{}) error
		BindQueryParams(req *http.Request, i interface{}) error
		BindBody(req *http.Request, i interface{}) (err error)
		BindHeaders(req *http.Request, i interface{}) error
	}
...
type BinderOption func(*DefaultBinder) error

func NewBinder(opts ...BinderOption) Binder {

	df := &DefaultBinder{
		maxMemory: 32 << 20, //32 mbs
	}
...
func WithCustomMemory(memory int64) BinderOption {
	return func(b *DefaultBinder) error {
		b.maxMemory = memory
		return nil
	}
}
...
func (b *DefaultBinder) BindBody(req *http.Request, i interface{}) (err error) {
	...
	case strings.HasPrefix(ctype, MIMEApplicationJSON):
		if err = b.deserialize(req, i); err != nil {
			return err
		}
	...
	default:
		return fmt.Errorf(MIMEUnsupport)
	}
	return nil
}
...
func (d *DefaultBinder) serialize(res http.ResponseWriter, i interface{}, indent string) error {
...
func (d *DefaultBinder) deserialize(req *http.Request, i interface{}) error {
...
func (c *DefaultBinder) formParams(req *http.Request) (url.Values, error) {
	if strings.HasPrefix(req.Header.Get(HeaderContentType), MIMEMultipartForm) {
		if err := req.ParseMultipartForm(c.maxMemory); err != nil {
			return nil, err
		}
	} else {
